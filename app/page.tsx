  ...
  return (
    ...
    >
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="relative flex flex-col items-center justify-center text-center py-20 md:py-32 overflow-hidden bg-white dark:bg-gray-900">
          {/* Soft blurred gradient background accent */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
            <div className="w-[480px] h-[320px] md:w-[640px] md:h-[420px] bg-gradient-to-br from-purple-200 via-orange-100 to-white dark:from-purple-900/40 dark:via-orange-900/20 dark:to-gray-900 rounded-full blur-3xl opacity-60"></div>
          </div>
          {/* Hero Content */}
          <div className="relative z-10 flex flex-col items-center animate-fade-in-up w-full">
            <h1
              className="text-4xl md:text-6xl font-bold mb-4 mt-0 md:mt-0 leading-tight tracking-tight text-gray-900 dark:text-white"
              style={{ fontFamily: '"DM Serif Display", serif' }}
            >
              Welcome to <span style={{ fontFamily: '"Grand Hotel", cursive', color: '#a259e6', fontWeight: 400 }}>SilverCircle</span>!<br />
              <span className="block text-2xl md:text-3xl font-normal mt-2 text-purple-700 dark:text-purple-300" style={{ fontFamily: 'Poppins, Arial, Helvetica, sans-serif' }}>
                Where every connection shines.
              </span>
            </h1>
            {/* Glowing Circle Image */}
            <div className="relative mt-16 mb-8 flex items-center justify-center">
              <span className="absolute w-[420px] h-[420px] md:w-[520px] md:h-[520px] rounded-full bg-gradient-to-br from-purple-300 via-orange-100 to-yellow-100 blur-xl opacity-35 animate-pulse-slow"></span>
              <Image
                src="/circle.png"
                alt="SilverCircle Glowing Circle"
                width={600}
                height={600}
                className="relative rounded-full shadow-2xl border-4 border-white dark:border-gray-900"
                priority
              />
            </div>
            <Button
              size="lg"
              className="text-lg px-8 py-4 bg-gradient-to-r from-purple-600 to-orange-500 hover:from-purple-700 hover:to-orange-600 text-white rounded-full shadow-lg transform transition-all duration-200 animate-fade-in"
              asChild
              style={{ fontFamily: 'Poppins, Arial, Helvetica, sans-serif' }}
            >
              <Link href="/profile">Join Our Community</Link>
            </Button>
          </div>
          {/* Subtle fade-in-up and pulse-slow animation */}
          <style jsx global>{`
            ...
            .animate-fade-in {
              animation: fade-in 1.6s cubic-bezier(0.23, 1, 0.32, 1);
            }
            @keyframes fade-in {
              0% { opacity: 0; }
              100% { opacity: 1; }
